                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $row['empid']; ?>">Edit</button>
                            <button class="btn btn-danger btn-sm delete btn-flat" data-id="<?php echo $row['empid']; ?>"> Delete</button>
                          </td>
                        </tr>
                      <?php
                    }
