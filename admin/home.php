...
<i class="ion ion-person-stalker"></i>
            ...
            <a href="employee.php" class="small-box-footer">More info </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<i class="ion ion-clock"></i>
            ...
            <a href="attendance.php" class="small-box-footer">More info </a>
          </div>
        </div>
...
<i class="ion ion-alert-circled"></i>
      ...
      <img src="Biometric Systems.jpg" alt="" width="1200" height="600">
        <!-- graph -->
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
